...
int build_qp_01(size_t &sizeH, size_t &nnzH, double* &q,
 ...
 colH[0]=0;colH[1]=2;colH[2]=4;
 rowH[0]=0;rowH[1]=1;rowH[2]=1;
 valH[0]=2;valH[1]=0;valH[2]=2;

 colA[0]=0;colA[1]=4;colA[2]=8;
 rowA[0]=0;rowA[1]=1;rowA[2]=2;rowA[3]=3;
 rowA[4]=0;rowA[5]=1;rowA[6]=2;rowA[7]=3;
 valA[0]=2;valA[1]=1;valA[2]=-1;valA[3]=-2;
 valA[4]=1;valA[5]=-1;valA[6]=-1;valA[7]=1;
 b_ineq[0]=2;b_ineq[1]=1;b_ineq[2]=1;b_ineq[3]=2;
...
int build_qp_02(size_t &sizeH, size_t &nnzH, double* &q,
 ...
 colH[0]=0;colH[1]=2;colH[2]=3;
 rowH[0]=0;rowH[1]=1;rowH[2]=1;
 valH[0]=2;valH[1]=0;valH[2]=2;

 colA[0]=0;colA[1]=5;colA[2]=10;
 rowA[0]=0;rowA[1]=1;rowA[2]=2;rowA[3]=3;
 rowA[4]=4;rowA[5]=0;rowA[6]=1;rowA[7]=2;
 rowA[8]=3;rowA[9]=4;

 valA[0]=-1;valA[1]=1;valA[2]=1;valA[3]=-1;
 valA[4]=0;valA[5]=2;valA[6]=2;valA[7]=-2;
 valA[8]=0;valA[9]=-1;
 b_ineq[0]=2;b_ineq[1]=6;b_ineq[2]=2;
 b_ineq[3]=0;b_ineq[4]=0;
 ...
 *
 ...
 1, 4, 8
 */
 colH[0]=0;colH[1]=3;colH[2]=5;colH[3]=6;
 rowH[0]=0;rowH[1]=1;rowH[2]=2;
 rowH[3]=1;rowH[4]=2;rowH[5]=2;

 valH[0]=8;valH[1]=-2;valH[2]=1;
 valH[3]=8;valH[4]=4;valH[5]=8;

 colA[0]=0;colA[1]=3;colA[2]=6;colA[3]=9;
 rowA[0]=0;rowA[1]=1;rowA[2]=2;rowA[3]=0;
 rowA[4]=1;rowA[5]=2;rowA[6]=0;rowA[7]=1;
 rowA[8]=2;

 valA[0]=-1;valA[1]=0;valA[2]=-1;valA[3]=0;
 valA[4]=-1;valA[5]=-1;valA[6]=-2;valA[7]=0;
 valA[8]=-3;
 b_ineq[0]=0;b_ineq[1]=0;b_ineq[2]=-2;
 ...
 */
 ...
 colB[0]=0;colB[1]=1;colB[2]=2;colB[3]=3;
 rowB[0]=0;rowB[1]=0;rowB[2]=0;

 valB[0]=0;valB[1]=0;valB[2]=2;
 b_eq[0]=1;
...
struct qp_info{
 ...
 qp_info():num_refactor(0),num_solve(0),num_update(0),num_downdate(0),
...
struct idx_val{
 ...
 idx_val(int i, double v):val(v),idx(i){
 }
};
