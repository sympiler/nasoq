...
PATHQP=$PATHMAIN/biharmonic_qps/
    ...
    n=hand
        for f in {1..3}; do
            $BINLIB 2 $PATHQP/${n}${f}_s_P.mtx $PATHQP/${n}${f}_s_q.mtx $PATHQP/${n}${f}_s_l.mtx $PATHQP/${n}${f}_s_A.mtx $PATHQP/${n}${f}_s_u.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod
    ...
    n=lion
     ...
     for n in {alligator,woody}; do
        for f in {1..5}; do
            $BINLIB 2 $PATHQP/${n}${f}_P.mtx $PATHQP/${n}${f}_q.mtx $PATHQP/${n}${f}_l.mtx $PATHQP/${n}${f}_A.mtx $PATHQP/${n}${f}_u.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod
            printf "Image deformation,"
            echo""
        done
    done
...
do
  $BINLIB 2 $PATHQP/${f}_P $PATHQP/${f}_q $PATHQP/${f}_l $PATHQP/${f}_A $PATHQP/${f}_u $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
...
PATHQP=$PATHMAIN/MarosMezaros/
# "2D Problems"
$BINLIB 1 $PATHQP/multiple_contacts_hP.mtx $PATHQP/multiple_contacts_q none none $PATHQP/multiple_contacts_A.mtx $PATHQP/multiple_contacts_l $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
printf "Contact simulation,"
echo ""


$BINLIB 1 $PATHQP/contact_starting_hP.mtx $PATHQP/contact_starting_q none none $PATHQP/contact_starting_A.mtx $PATHQP/contact_starting_l $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
printf "Contact simulation,"
echo ""

$BINLIB 1 $PATHQP/no_contact_hP.mtx $PATHQP/no_contact_q none none $PATHQP/no_contact_A.mtx $PATHQP/no_contact_l $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
printf "Contact simulation,"
echo ""

$BINLIB 1 $PATHQP/recontactqps_hP.mtx $PATHQP/recontactqps_q none none $PATHQP/recontactqps_A.mtx $PATHQP/recontactqps_l $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
printf "Contact simulation,"
echo""
...
for f in {8..10};
do
  ${BINLIB} 1 $PATHQP/Ph${f}.mtx $PATHQP/q${f} none none $PATHQP/A${f} $PATHQP/l${f} $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
...
for f in {7..9};
do
 ${BINLIB} 1 $PATHQP/nail0${f}t_hP.mtx $PATHQP/nail0${f}t_q.mtx $PATHQP/nail0${f}t_A.mtx $PATHQP/nail0${f}t_b.mtx $PATHQP/nail0${f}t_C.mtx $PATHQP/nail0${f}t_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
...
for f in {10..18};
do
 ${BINLIB} 1 $PATHQP/nail${f}t_hP.mtx $PATHQP/nail${f}t_q.mtx $PATHQP/nail${f}t_A.mtx $PATHQP/nail${f}t_b.mtx $PATHQP/nail${f}t_C.mtx $PATHQP/nail${f}t_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
  printf "Cloth simulation,"
  echo ""
done
...
for f in {0..1};
do
 ${BINLIB} 1 $PATHQP/bunny2_bunny${f}_hP.mtx $PATHQP/bunny2_bunny${f}_q.mtx none none $PATHQP/bunny2_bunny${f}_C.mtx $PATHQP/bunny2_bunny${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
#for f in {0..1};
#do
f=0
 ${BINLIB} 1 $PATHQP/bunny2_falling${f}_hP.mtx $PATHQP/bunny2_falling${f}_q.mtx none none $PATHQP/bunny2_falling${f}_C.mtx $PATHQP/bunny2_falling${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
#done
for f in {0..1};
do
 ${BINLIB} 1 $PATHQP/bunny_bunny${f}_hP.mtx $PATHQP/bunny_bunny${f}_q.mtx none none $PATHQP/bunny_bunny${f}_C.mtx $PATHQP/bunny_bunny${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
#for f in {0..1};
#do
f=0
 ${BINLIB} 1 $PATHQP/bunny_falling${f}_hP.mtx $PATHQP/bunny_falling${f}_q.mtx none none $PATHQP/bunny_falling${f}_C.mtx $PATHQP/bunny_falling${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
#done
...
for f in {0..5};
do
 ${BINLIB} 1 $PATHQP/horse_horse${f}_hP.mtx $PATHQP/horse_horse${f}_q.mtx none none $PATHQP/horse_horse${f}_C.mtx $PATHQP/horse_horse${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
for f in {0..1};
do
 ${BINLIB} 1 $PATHQP/horse_falling${f}_hP.mtx $PATHQP/horse_falling${f}_q.mtx none none $PATHQP/horse_falling${f}_C.mtx $PATHQP/horse_falling${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
...
for f in {0..19};
do
 ${BINLIB} 1 $PATHQP/knight_knight${f}_hP.mtx $PATHQP/knight_knight${f}_q.mtx none none $PATHQP/knight_knight${f}_C.mtx $PATHQP/knight_knight${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
for f in {0..1};
do
 ${BINLIB} 1 $PATHQP/knight_falling${f}_hP.mtx $PATHQP/knight_falling${f}_q.mtx none none $PATHQP/knight_falling${f}_C.mtx $PATHQP/knight_falling${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
...
for f in {0..36};
do
 ${BINLIB} 1 $PATHQP/lamb_lamb${f}_hP.mtx $PATHQP/lamb_lamb${f}_q.mtx none none $PATHQP/lamb_lamb${f}_C.mtx $PATHQP/lamb_lamb${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
#for f in {0..1};
#do
f=0
 ${BINLIB} 1 $PATHQP/lamb_falling${f}_hP.mtx $PATHQP/lamb_falling${f}_q.mtx none none $PATHQP/lamb_falling${f}_C.mtx $PATHQP/lamb_falling${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
#done
...
for f in {1..3};
do
 ${BINLIB} 1 $PATHQP/matt_qp${f}_hP.mtx $PATHQP/matt_qp${f}_q.mtx none none $PATHQP/matt_qp${f}_C.mtx $PATHQP/matt_qp${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
...
for f in {0..6};
do
 ${BINLIB} 1 $PATHQP/wolf_falling${f}_hP.mtx $PATHQP/wolf_falling${f}_q.mtx none none $PATHQP/wolf_falling${f}_C.mtx $PATHQP/wolf_falling${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done


${BINLIB} 1 $PATHQP/garg3_garg30_hP.mtx $PATHQP/garg3_garg30_q.mtx none none $PATHQP/garg3_garg30_C.mtx $PATHQP/garg3_garg30_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
printf "Contact simulation,"
echo ""

for f in {0..1};
do
 ${BINLIB} 1 $PATHQP/garg3_floor${f}_hP.mtx $PATHQP/garg3_floor${f}_q.mtx none none $PATHQP/garg3_floor${f}_C.mtx $PATHQP/garg3_floor${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
...
for f in {0..14};
do
 ${BINLIB} 1 $PATHQP/garg2_garg2${f}_hP.mtx $PATHQP/garg2_garg2${f}_q.mtx none none $PATHQP/garg2_garg2${f}_C.mtx $PATHQP/garg2_garg2${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
...
for f in {0..87};
do
 ${BINLIB} 1 $PATHQP/garg_floor${f}_hP.mtx $PATHQP/garg_floor${f}_q.mtx none none $PATHQP/garg_floor${f}_C.mtx $PATHQP/garg_floor${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
...
for f in {0..15};
do
  ${BINLIB} 1 $PATHQP/arma1_arma${f}_hP.mtx $PATHQP/arma1_arma${f}_q.mtx none none $PATHQP/arma1_arma${f}_C.mtx $PATHQP/arma1_arma${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
...
for f in {2..270};
do
  ${BINLIB} 1 $PATHQP/Bar2k_floor${f}_hP.mtx $PATHQP/Bar2k_floor${f}_q.mtx none none $PATHQP/Bar2k_floor${f}_C.mtx $PATHQP/Bar2k_floor${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
...
for f in {0..338};
do
  ${BINLIB} 1 $PATHQP/Beam_floor${f}_hP.mtx $PATHQP/Beam_floor${f}_q.mtx none none $PATHQP/Beam_floor${f}_C.mtx $PATHQP/Beam_floor${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
...
for f in {2..524};
do
  ${BINLIB} 1 $PATHQP/Cube_floor${f}_hP.mtx $PATHQP/Cube_floor${f}_q.mtx none none $PATHQP/Cube_floor${f}_C.mtx $PATHQP/Cube_floor${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
...
for f in {0..71};
do
  ${BINLIB} 1 $PATHQP/gargNested2_falling${f}_hP.mtx $PATHQP/gargNested2_falling${f}_q.mtx none none $PATHQP/gargNested2_falling${f}_C.mtx $PATHQP/gargNested2_falling${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
...
for f in {0..279};
do
  ${BINLIB} 1 $PATHQP/gargNested2_floor${f}_hP.mtx $PATHQP/gargNested2_floor${f}_q.mtx none none $PATHQP/gargNested2_floor${f}_C.mtx $PATHQP/gargNested2_floor${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
...
for f in {0..56};
do
  ${BINLIB} 1 $PATHQP/gargNested2_gargNested2${f}_hP.mtx $PATHQP/gargNested2_gargNested2${f}_q.mtx none none $PATHQP/gargNested2_gargNested2${f}_C.mtx $PATHQP/gargNested2_gargNested2${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
 printf "Contact simulation,"
 echo ""
done
...
for f in {0..3};
do
 ${BINLIB} 1 $PATHQP/InjBnd_Mapping${f}_hP.mtx $PATHQP/InjBnd_Mapping${f}_q.mtx $PATHQP/InjBnd_Mapping${f}_A.mtx $PATHQP/InjBnd_Mapping${f}_b.mtx $PATHQP/InjBnd_Mapping${f}_C.mtx $PATHQP/InjBnd_Mapping${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
...
for f in {0..2};
do
 ${BINLIB} 1 $PATHQP/InjBnd_MappingImp${f}_hP.mtx $PATHQP/InjBnd_MappingImp${f}_q.mtx $PATHQP/InjBnd_MappingImp${f}_A.mtx $PATHQP/InjBnd_MappingImp${f}_b.mtx $PATHQP/InjBnd_MappingImp${f}_C.mtx $PATHQP/InjBnd_MappingImp${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
  printf "Mesh processing,"
  echo ""
done
...
do
  ${BINLIB} 1 $PATHQP/${f}_hP.mtx $PATHQP/${f}_q.mtx $PATHQP/${f}_A.mtx $PATHQP/${f}_b.mtx $PATHQP/${f}_C.mtx $PATHQP/${f}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
...
for j in {0..19}; do
  ${BINLIB} 1 $PATHQP/${f}_${j}_P.mtx $PATHQP/${f}_${j}_q.mtx $PATHQP/${f}_${j}_A.mtx $PATHQP/${f}_${j}_b.mtx $PATHQP/${f}_${j}_C.mtx $PATHQP/${f}_${j}_d.mtx $reg_diag $out_iter $in_iter $eps $tol $sol_mod;
  printf "MPC,"
  echo ""
done
done
